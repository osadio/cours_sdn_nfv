...
class MyTopo( Topo ):  
     def build( self ):     
        ...
        self.addLink(s1, s2, cls=TCLink, bw=10000, delay=10)
        self.addLink(s2, s3, cls=TCLink, bw=100, delay=100)
        self.addLink(s3, s4, cls=TCLink, bw=1000, delay=50)
        self.addLink(s4, s1, cls=TCLink, bw=10000, delay=10)
